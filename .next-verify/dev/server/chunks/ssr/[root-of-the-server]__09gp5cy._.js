...
const metadata = {
    ...
    description: "RentHaven helps landlords and property managers collect rent, manage tenants, track leases, and handle maintenance requests - all from one simple dashboard.",
    openGraph: {
        title: "RentHaven - Rental Property Management Software",
        description: "Collect rent, manage tenants, and track leases in one simple dashboard built for landlords and property managers.",
        type: "website",
        locale: "en_US",
        siteName: "RentHaven"
    }
